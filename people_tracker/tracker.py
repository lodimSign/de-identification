...
def process_image(image_path):
    # Load YOLOv3 model
    net = cv2.dnn.readNet('C:\workspace\people_tracker2\models\yolov3.weights', 'C:\workspace\people_tracker2\models\yolov3.cfg')

    # Load COCO class names
    with open('C:\workspace\people_tracker2\models\coco.names', 'r') as f:
